...
public:
	...
	/*me => setter for the current player*/
	...
	//me: method to get the GameObject at a specific cell position !!!!!!
	GameObject* GetGameObjectAt(const CellPosition& pos);

	//me: 
	CellPosition GetEndPosition() const;
	
	~Grid(); 
	bool IsObjectOverlapping(GameObject* newObject) const;
